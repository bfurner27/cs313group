...
import scriptures.bll.FileScriptureHandler;
import scriptures.bll.Scripture;
import scriptures.bll.ScriptureListHandler;
...
public class CreateScripture extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //add a scripture to the list of scriptures
        ScriptureListHandler handler = new FileScriptureHandler("list.txt");
        handler.addScripture(new Scripture(book, chapter, verse));
