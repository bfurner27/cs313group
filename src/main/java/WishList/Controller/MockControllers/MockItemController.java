...
public class MockItemController implements ItemController {
    ...
    public List<Item> getItems(int listId){
        try {
            ...
            if (listId == 1) {
                items.add(new Item(new URL("http://ecx.images-amazon.com/images/I/41h64p3BYtL._AA160_.jpg"), new URL("http://www.amazon.com/20030578-ASDF/dp/B004OBY8IG/ref=sr_1_1?ie=UTF8&qid=1435700253&sr=8-1&keywords=asdf"), "Its a car!", "ASDF", (float) 59.99, 1, 1));
                items.add(new Item(new URL("http://ecx.images-amazon.com/images/I/51XwRGpkEXL._AA160_.jpg"), new URL("http://www.amazon.com/Greatest-Hits-Amazon-Exclusive-Fighters/dp/B002UHSDUK/ref=sr_1_2?ie=UTF8&qid=1435700261&sr=8-2&keywords=foo"), "Foo Fighters CD", "Sonic Highways", (float) 10.30, 2, 1));
                items.add(new Item(new URL("http://ecx.images-amazon.com/images/I/51kTR4SvmSL._PI_PJStripe-HD-Only-500px,TopLeft,0,0_AA160_.jpg"), new URL("http://www.amazon.com/This-40-Unrated-Paul-Rudd/dp/B00BGIBVP8/ref=sr_1_1?ie=UTF8&qid=1435701187&sr=8-1&keywords=this"), "I don't know what there is 40 of", "This is 40", (float) 2.99, 3, 1));
                items.add(new Item(new URL("http://ecx.images-amazon.com/images/I/41YzinELUDL._AA160_.jpg"), new URL("http://www.amazon.com/Winsome-Newport-Expandable-Wine-Bar/dp/B001B2PA6A/ref=sr_1_1?ie=UTF8&qid=1435701337&sr=8-1&keywords=bar"), "Searching for bar", "A table thing...", (float) 192.90, 4, 1));
            }
            else {
                items.add(new Item(new URL("http://ecx.images-amazon.com/images/I/41xmPQeiLZL._AA160_.jpg"), new URL("http://www.amazon.com/listlessness-granny-FooBar-Dragon-Comics/dp/4091406270/ref=sr_1_1?ie=UTF8&qid=1435701444&sr=8-1&keywords=foobar"), "I searched for foobar and this was too good to pass up", "Ho and listlessness listlessness granny gag gag tales of old Japan one of FooBar old man", (float) 5.16, 5, 2));
